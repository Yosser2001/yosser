...
<!-- Mirrored from techpedia.co.uk/template/stylen/index-1.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Aug 2023 13:23:19 GMT -->
<head>
    <!-- Meta Data -->
    <meta charset="UTF-8">
...
<body>
    ...
    <div id="main-wrapper" class="main-wrapper">
        ...
        <header class="header style-3 d-none">
            ...
            <nav class="navbar navbar-expand-lg">
                <div class="container">
                    <a href="tel:55973443" class="phone-link show-on-dekstop"><i class="fal fa-phone"></i> 55973443</a>
                    ...
                    <div class="collapse navbar-collapse" id="mynavbar-3">
                        <ul class="navbar-nav ms-auto me-auto mainmenu">
                            <li class="menu-item-has-children">
                                <a href="javascript:void(0);" class="active">Home</a>
                                <ul class="stylen-submenu">
                                    <li><a href="index-1.php" class="active">Home 1</a></li>
                            ...
                            <li class="menu-item-has-children">
                                ...
                                <ul class="stylen-submenu multiline">
                                    ...
                                    <li><a href="blogs-2.php">Blogs 2</a></li>
                                    <li><a href="blog-detail.php">Blog Detail</a></li>
                                    <li><a href="appointment-1.php">Appointment 1</a></li>
        ...
        <section class="slider style-1">
            <div style="background: url('assets/media/banner/slider-bg-1.png');background-size: cover;background-position: center;">
                <div class="container">
                    <div class="content-wrap" data-sal="slide-up" data-sal-duration="800" data-sal-delay="100" data-sal-easing="ease-in-out">
                        <div class="content position-relative">
                            <h2 class="title">
                                Vous méritez <br> la <span>beauté</span>
                            </h2>
                        </div>
                    </div>
                </div>
            </div>
            <div style="background: url('assets/media/banner/slider-bg-2.png');background-size: cover;background-position: center;">
                <div class="container">
                    <div class="content-wrap" data-sal="slide-up" data-sal-duration="800" data-sal-delay="100" data-sal-easing="ease-in-out">
                        <div class="content position-relative">
                            <h2 class="title">
                                Peau éclatante <br>bien-être <span>assuré</span>
                            </h2>
                        </div>
                    </div>
                </div>
            </div>
            <div style="background: url('assets/media/banner/slider-bg-3.png');background-size: cover;background-position: center;" data-sal-easing="ease-in-out">
                <div class="container">
                    <div class="content-wrap" data-sal="slide-up" data-sal-duration="800" data-sal-delay="100">
                        <div class="content position-relative">
                            <h2 class="title">Découvrez votre <br>éclat naturel<span>chez nous</span></h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="services style-1 sec-mar background-1">
            <div class="container">
                <div class="heading">
                    <h2>SKIN AND BODY CARE SERVICES</h2>
                    <p> Stylen offers an array of beauty services designed to enhance both your appearance and confidence,<br> leaving you looking and feeling your absolute best .</p>
                </div>
                <div class="row" data-sal="slide-up" data-sal-duration="800" data-sal-delay="100" data-sal-easing="ease-in-out">
                    <div class="col-xl-3 col-lg-6 col-md-6">
                        <div class="service-box right-radius">
                            <div class="img-box">
                                <img src="assets/media/services/s-1.png" alt="">
                            </div>
                            <div class="content">
                                <h3><a href="service-detail.php">HAIR CARE🌸 </a></h3>
                                <p>Experience luxurious hair treatments and expert styling to achieve the perfect look for your tresses.</p>
                                <a href="appointment-1.php" class="stylen-btn btn-sec">BOOK NOW</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-6 col-md-6">
                        <div class="service-box left-radius">
                            <div class="img-box">
                                <img src="assets/media/services/s-2.png" alt="">
                            </div>
                            <div class="content">
                                <h3><a href="service-detail.php">NAIL CARE🌸 </a></h3>
                                <p>Pamper yourself with our professional nail care services, from stunning manicures to soothing pedicures, for elegant and well-groomed hands and feet.</p>
                                <a href="appointment-1.php" class="stylen-btn btn-sec">BOOK NOW</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-6 col-md-6">
                        <div class="service-box right-radius">
                            <div class="img-box">
                                <img src="assets/media/services/s-3.png" alt="">
                            </div>
                            <div class="content">
                                <h3><a href="service-detail.php">MAKE UP 🌸</a></h3>
                                <p>"Let our skilled makeup artists enhance your natural beauty and create stunning looks for any occasion, leaving you feeling glamorous and confident</p>
                                <a href="appointment-1.php" class="stylen-btn btn-sec">BOOK NOW</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-6 col-md-6">
                        <div class="service-box left-radius">
                            <div class="img-box">
                                <img src="assets/media/services/s-4.png" alt="">
                            </div>
                            <div class="content">
                                <h3><a href="service-detail.php">MASSAGE🌸 </a></h3>
                                <p>Relax and unwind with our indulgent massage therapies, designed to melt away stress and rejuvenate your body and mind</p>
                                <a href="appointment-1.php" class="stylen-btn btn-sec">BOOK NOW</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-xl-5">
                        <div class="content sec-pad"  data-sal="fade" data-sal-duration="400" data-sal-delay="100" data-sal-easing="ease-in-out">
                            <h3>20 <span class="top-text">%</span> <span class="bottom-text">OFF</span></h3>
                            <h3>ON FIRST <br> SERVICE YOU GET</h3>
                            <p>As a greeting to Salon Services, we are offering 20% off your first attempt when you request for a credit card with your voucher code. Everything you have to do is enter the following code into the shopping cart: YOSSER</p>
                            <a href="appointment-1.php" class="stylen-btn btn-primary btn-white right-arrow">BOOK APPOINTMENT</a>
                        </div>
                    </div>
                    <div class="col-xl-7">
                        <div class="discount-img-box">
                            <img class="top-image" src="assets/media/banner/discount-top-image.png" alt=""  data-sal="slide-down" data-sal-duration="400" data-sal-delay="100">
                            <img class="bottom-image" src="assets/media/banner/discount-bottom-image.png" alt="" data-sal="slide-up" data-sal-duration="400" data-sal-delay="100">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="pricing style-1 sec-mar background-1">
            <div class="container">
                <div data-sal="slide-up" data-sal-duration="800" data-sal-delay="100" data-sal-easing="ease-in-out">
                    <div class="heading">
                        <h2>PRICE PLANS🌸</h2>
                        <p>Unlock the benefits of our discounted beauty services <br>
                            helping you look and feel your best</p>
                    </div>
                    <div class="row">
                        <div class="col-xl-3 col-lg-6 col-md-6">
                            <div class="pricing-box">
                                ...
                                <div class="content">
                                    <div class="package">
                                        <p class="p-name"><a href="appointment-1.php">Blow Dry</a></p>
                                        <p class="price"><a href="appointment-1.php">25DT</a></p>
                                    </div>
                                    <div class="package">
                                        <p class="p-name"><a href="appointment-1.php">Basic Tint</a></p>
                                        <p class="price"><a href="appointment-1.php">45DT</a></p>
                                    </div>
                                    <div class="package">
                                        <p class="p-name"><a href="appointment-1.php">Organic Color</a></p>
                                        <p class="price"><a href="appointment-1.php">75DT</a></p>
                                    </div>
                                    <div class="package">
                                        <p class="p-name"><a href="appointment-1.php">Full Highlights</a></p>
                                        <p class="price"><a href="appointment-1.php">90DT</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-lg-6 col-md-6">
                            <div class="pricing-box">
                                ...
                                <div class="content">
                                    <div class="package">
                                        <p class="p-name"><a href="appointment-1.php">Pedicure</a></p>
                                        <p class="price"><a href="appointment-1.php">30DT</a></p>
                                    </div>
                                    <div class="package">
                                        <p class="p-name"><a href="appointment-1.php">Menicure</a></p>
                                        <p class="price"><a href="appointment-1.php">15DT</a></p>
                                    </div>
                                    <div class="package">
                                        <p class="p-name"><a href="appointment-1.php">Nail Paint</a></p>
                                        <p class="price"><a href="appointment-1.php">25DT</a></p>
                                    </div>
                                    <div class="package">
                                        <p class="p-name"><a href="appointment-1.php">Nail Art</a></p>
                                        <p class="price"><a href="appointment-1.php">25DT</a></p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6">
                            <div class="pricing-box">
                                ...
                                <div class="content">
                                    <div class="package">
                                        <p class="p-name"><a href="appointment-1.php">Basic Makeup</a></p>
                                        <p class="price"><a href="appointment-1.php">75DT</a></p>
                                    </div>
                                    <div class="package">
                                        <p class="p-name"><a href="appointment-1.php">Party Makeup</a></p>
                                        <p class="price"><a href="appointment-1.php">150DT</a></p>
                                    </div>
                                    <div class="package">
                                        <p class="p-name"><a href="appointment-1.php">Bridal Makeup</a></p>
                                        <p class="price"><a href="appointment-1.php">200DT</a></p>
                                    </div>
                                    <div class="package">
                                        <p class="p-name"><a href="appointment-1.php">Makeup</a></p>
                                        <p class="price"><a href="appointment-1.php">110DT</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-lg-6 col-md-6">
                            <div class="pricing-box">
                                ...
                                <div class="content">
                                    <div class="package">
                                        <p class="p-name"><a href="appointment-1.php">Massage</a></p>
                                        <p class="price"><a href="appointment-1.php">80DT</a></p>
                                    </div>
                                    <div class="package">
                                        <p class="p-name"><a href="appointment-1.php">Back Massage</a></p>
                                        <p class="price"><a href="appointment-1.php">95DT</a></p>
                                    </div>
                                    <div class="package">
                                        <p class="p-name"><a href="appointment-1.php">Face Massage</a></p>
                                        <p class="price"><a href="appointment-1.php">45DT</a></p>
                                    </div>
                                    <div class="package">
                                        <p class="p-name"><a href="appointment-1.php">Body Massage</a></p>
                                        <p class="price"><a href="appointment-1.php">150DT</a></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="title text-center">
                                        <h2>PRODUCTS🌸</h2>
                                        <p>All our products are certified by Cosmos and Ecocert, ensuring the highest standards of quality and sustainability </p>
                                        <a href="shop.php" class="stylen-btn btn-primary right-arrow">Visit shop</a>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-lg-6 col-md-6">
                            <div class="member-box text-center">
                                <div class="image-box">
                                    <img src="assets/media/team/hair.jpeg" alt="">
                                </div>
                                <div class="member-detail text-center">
                                    <h6 class="m-name"><a href="team-detail.php">Eric Zammour </a></h6>
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6">
                            <div class="member-box text-center">
                                <div class="image-box">
                                    <img src="assets/media/team/m-2.png" alt="">
                                </div>
                                <div class="member-detail text-center">
                                    <h6 class="m-name"><a href="team-detail.php">AIRENE MOLLY</a></h6>
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6">
                            <div class="member-box text-center">
                                <div class="image-box">
                                    <img src="assets/media/team/m-3.png" alt="">
                                </div>
                                <div class="member-detail text-center">
                                    <h6 class="m-name"><a href="team-detail.php">ALEXI ALLEN</a></h6>
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6">
                            <div class="member-box text-center">
                                <div class="image-box">
                                    <img src="assets/media/team/m-4.png" alt="">
                                </div>
                                <div class="member-detail text-center">
                                    <h6 class="m-name"><a href="team-detail.php">SOFIA KELLY</a></h6>
                                    <p class="job-title">MASSAGE SPECIALIST</p>
                                    <a href="appointment-1.php" class="stylen-btn btn-sec">BOOK NOW</a>
                                </div>
                            </div>
        ...
        <section class="gallery sec-mar background-2">
            <div class="container">
                <div class="heading">
                    ...
                    <p>Discover your inner and outer beauty with the stunning makeup and skincare collections at Beauty Gallery.<br>
                        Unveil your unique radiance and shine with confidence every day!🌸</p>
                </div>
                <div class="row">
                    <div class="col-lg-4" data-sal="slide-down" data-sal-duration="800" data-sal-delay="100" data-sal-easing="ease-in-out">
                        <img src="assets/media/gallery/g-1.png" alt="" class="horizontal">
                        <img src="assets/media/gallery/g-2.png" alt="" class="horizontal">
                    </div>
                    <div class="col-lg-4" data-sal="slide-down" data-sal-duration="800" data-sal-delay="100" data-sal-easing="ease-in-out">
                        <img src="assets/media/gallery/g-3.png" alt="" class="vertical">
                    </div>
                    <div class="col-lg-4" data-sal="slide-down" data-sal-duration="800" data-sal-delay="100" data-sal-easing="ease-in-out">
                        <img src="assets/media/gallery/g-4.png" alt="" class="horizontal">
                        <img src="assets/media/gallery/g-5.png" alt="" class="horizontal">
                    </div>
                    <div class="col-lg-4" data-sal="slide-up" data-sal-duration="800" data-sal-delay="100" data-sal-easing="ease-in-out">
                        <img src="assets/media/gallery/g-6.png" alt="" class="horizontal">
                    </div>
                    <div class="col-lg-4" data-sal="slide-up" data-sal-duration="800" data-sal-delay="100" data-sal-easing="ease-in-out">
                        <img src="assets/media/gallery/g-7.png" alt="" class="horizontal">
                    </div>
                    <div class="col-lg-4" data-sal="slide-up" data-sal-duration="800" data-sal-delay="100" data-sal-easing="ease-in-out">
                        <img src="assets/media/gallery/g-9.png" alt="" class="horizontal">
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row partner-slider">
                    <div class="col-lg-2 logo">
                        <img alt="" src="assets/media/partners/p-1.svg">
                    </div>
                    <div class="col-lg-2 logo">
                        <img alt="" src="assets/media/partners/p-2.svg">
                    </div>
                    <div class="col-lg-2 logo">
                        <img alt="" src="assets/media/partners/p-3.svg">
                    </div>
                    <div class="col-lg-2 logo">
                        <img alt="" src="assets/media/partners/p-4.svg">
                    </div>
                    <div class="col-lg-2 logo">
                        <img alt="" src="assets/media/partners/p-5.svg">
                    </div>
                    <div class="col-lg-2 logo">
                        <img alt="" src="assets/media/partners/p-6.svg">
                    </div>
                    <div class="col-lg-2 logo">
                        <img alt="" src="assets/media/partners/p-3.svg">
                    </div>
        ...
        <section class="testimonials sec-mar background-2">
            <div class="container">
                <div data-sal="slide-up" data-sal-duration="800" data-sal-delay="100" data-sal-easing="ease-in-out">
                    <div class="heading">
                        <h2>🌸HAPPY CLIENTS🌸</h2>
                        <p>What do you think about the new collection <br>
                            at Beauty Gallery?</p>
                    </div>
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="testimonial-box border-left">
                                <div class="client d-flex">
                                    <img src="assets/media/testimonial/user-1.jpg" alt="">
                                    <div class="info">
                                        <h3>LAURA HELM</h3>
                                        <h6>STYLED BY: PERRI JONAS</h6>
                                    </div>
                                </div>
                                <p>Style Salon has been providing me with a variety of services for quite some time, and I keep returning because their expertise.</p>
                            </div>
                        </div>
                        <div class="col-xl-4 col-md-6">
                            <div class="testimonial-box">
                                <div class="client d-flex">
                                    <img src="assets/media/testimonial/user-2.jpg" alt="">
                                    <div class="info">
                                        <h3>POLY GREY</h3>
                                        <h6>STYLED BY: PERRI JONAS</h6>
                                    </div>
                                </div>
                                <p>Stylen Salon provided an incredible hair transformation for both me and my mother. Everything was extremely professional.</p>
                            </div>
                        </div>
                        <div class="col-xl-4 col-md-6 offset-xl-0 offset-md-3">
                            <div class="testimonial-box">
                                <div class="client d-flex">
                                    <img src="assets/media/testimonial/user-3.jpg" alt="">
                                    <div class="info">
                                        <h3>SOPHIA ALAN</h3>
                                        <h6>STYLED BY: PERRI JONAS</h6>
                                    </div>
                                </div>
                                <p>It's a fantastic experience, especially because I adore Perri Jonas's haircuts. They are incredibly kind people.</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- Mirrored from techpedia.co.uk/template/stylen/index-1.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Aug 2023 13:23:46 GMT -->
</html>
