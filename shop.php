...
<!-- Mirrored from techpedia.co.uk/template/stylen/shop.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Aug 2023 13:24:12 GMT -->
<head>
    <!-- Meta Data -->
    <meta charset="UTF-8">
    ...
    <style>
    /* Style pour les détails des produits */
    .product-details h3 {
        font-size: 1.2em;
        margin-bottom: 5px;
        color: #070707 ;
...
<body>
    ...
    window.addEventListener('load', function() {
        // Cacher le préchargeur une fois la page chargée
                    ...
                    <div class="row">
                        <div class="col-lg-9 col-sm-9 col-12">
                            <ul>
                                ...
                                <li><a href="tel:55973443"><i class="fal fa-mobile"></i> +21655973443</a></li>
                    ...
                    <div class="collapse navbar-collapse" id="mynavbar-1">
                        <ul class="navbar-nav ms-auto me-auto mainmenu">
                            ...
                            <li class="menu-item-has-children">
                                ...
                                <ul class="stylen-submenu">
                                    <li><a href="shop.php" class="active">Product Listing</a></li>
    ...
    <div class="container">
        <div class="row mb-3 justify-content-between">
            <div class="col-xl-5 col-lg-4 col-md-6">
                ...
                <form method="get" action="shop.php#product-list">
            ...
            <div class="col-xl-6 col-lg-8 col-md-12">
                <div class="shop-tags">
                    <ul class="list-unstyled">
                        <li><a class="active" href="shop.php#product-list">ARTICLES</a></li>
                    </ul>
                </div>
            </div>
        </div>
        <section class="products-section" id="product-list">
            ...
            <div class="row">
                ...
                if (isset($_GET['search']) && !empty($_GET['search'])) {
                    ...
                    // Construire la requête SQL pour récupérer les produits correspondant au terme de recherche
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo '<div class="product-grid" data-sal="slide-up" data-sal-duration="1000" data-sal-delay="100">';
                        echo '<img src="backend/products/' . $row['image_path'] . '" alt="">';
                        echo '<div class="content">';
                        echo '<a href=""><h5 class="title">' . htmlspecialchars($row["name"]) . '</h5></a>';
                        echo '<hr>';
                        echo '<p class="price" style="width: 150px;">' . number_format($row["price"], 2, ',', ' ') . ' DT</p>';
                        echo '<p class="detail">' . htmlspecialchars($row["description"]) . '</p>';
                        echo '</div>';
                        echo '</div>';
                        echo '</div>';
                    ...
                    <div class="row justify-content-between">
                        <div class="col-xl-4 col-lg-6 col-sm-12 col-12">
                            <div class="footer-widget">
                                ...
                                <p class="about">Stylen Salon provides a variety of beauty services that will help you feel and appear your best. Our services range from hair care products and styling to makeup.</p>
                                <ul class="list-unstyled">
                                    <li><a class="contact-link mb-2" href="tel:559734439"><i class="fas fa-phone-alt"></i> +216
                                        55973443</a></li>
...
<!-- Mirrored from techpedia.co.uk/template/stylen/shop.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Aug 2023 13:24:19 GMT -->
</html>