...
<meta charset="UTF-8">
    ...
    <!-- color Stylesheet -->
         ...
         <link rel="stylesheet" href="http://localhost/pfa/template/stylen/assets/css/app.css">
         <!-- Meta Data -->
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>Stylen | 🌸Salon & Spa </title>
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="assets/media/favicon.png">
                    ...
                    <div class="row">
                        <div class="col-lg-9 col-sm-9 col-12">
                            <ul>
                                ...
                                <li><span><i class="fal fa-clock"></i> Everyday 7 AM to 9 PM Sunday Off</span></li>
                            </ul>
                        </div>
        ...
        <header class="header style-2">
            ...
            <nav class="navbar navbar-expand-lg">
                <div class="container">
                    ...
                    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#mynavba-2">
                        <i class="fas fa-bars"></i>
                    </button>
                    <div class="collapse navbar-collapse" id="mynavba-2">
                       ...
                       <li><a href="shop.php">Shop</a></li>
                            ...
                            <li class="menu-item-has-children">
                                    ...
                                    <li  class="stylen-submenu multiline"><a href="login.php">login</a></li>
                        ...
                        <div class="d-flex right-nav">
                            <a href="tel:55973443" class="phone-link"><i class="fal fa-phone"></i> 55973443</a>
                        </div>
                    </div>
                </div>
            </nav>
                    ...
                    <div class="modal-body">
                        <div class="text-center">
                            <div class="success-circle" >
                                <div class="checkmark" >
                                    <span style="color: black;"  class="icon">&#10004;</span>
                                </div>
                            </div>
                            <h3 style="color: #FFA28D;">Appointment Booked Successfully!</h3>
                        </div>

                        <table class="table table-striped">
    <tr>
        <th>Date:</th>
        <td><?php echo isset($_GET['date']) ? $_GET['date'] : ''; ?></td>
    </tr>
    <tr>
        <th>Time:</th>
        <td><?php echo isset($_GET['time']) ? $_GET['time'] . ":00" : ''; ?></td>
    </tr>
    <tr>
        <th>Service:</th>
        <td><?php echo isset($_GET['services']) ? $_GET['services'] : ''; ?></td>
    </tr>
    <tr>
        <th>Masseuse:</th>
        <td><?php echo isset($_GET['employee']) ? "EMPLOYEE " . $_GET['employee'] : ''; ?></td>
    </tr>
</table>
                    </div>
                </div>
                            ...
                            <div class="content text-center">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-4  col-lg-6 col-md-6 col-12">
                                        <div class="content-box">
                                            <h6>PHONE</h6>
                                            <a class="phone" href="tel:55973443"><i class="fas fa-phone-alt"></i> +216 55973443 </a>
                                        </div>
                                    </div>
                    ...
                    <div class="row justify-content-between">
                        ...
                        <div class="col-xl-3 col-lg-6 col-sm-12 col-12">
                            <div class="footer-widget">
                                ...
                                <a class="address" href="#"><i class="fal fa-map-marker-alt"></i> Rue Mongi Slim
                                    LE Kef, Tunisie </a>
                            </div>
                        </div>
