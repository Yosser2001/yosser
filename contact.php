...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $recipient = "yosserkhaldi2001@gmail.com"; // Remplacez par votre adresse e-mail
    ...
    // Configuration des en-têtes de l'e-mail
    ...
    if (mail($recipient, $subject, $message, $headers)) {
        ...
        $messageStatus = "Échec de l'envoi du message. Veuillez réessayer ultérieurement.";
    }
}
?>
...
<!-- Mirrored from techpedia.co.uk/template/stylen/contact.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Aug 2023 13:24:27 GMT -->
<head>
    <!-- Meta Data -->
    <meta charset="UTF-8">
...
<body>
    ...
    <div id="main-wrapper" class="main-wrapper">
        ...
        <header class="header style-3 d-none">
            ...
            <nav class="navbar navbar-expand-lg">
                <div class="container">
                    <a href="tel:55973443" class="phone-link show-on-dekstop"><i class="fal fa-phone"></i> +216 55973443</a>
                ...
                <div class="row">
                    <div class="col-xl-4">
                        <div class="contact-box">
                            ...
                            <hr>
                            <div class="list mb-4">
                                <a href="tel:55973443" class="link"><i class="fal fa-phone-alt"></i> +216 55973443</a>
                            </div>
                            <div class="list">
                                <a href="mailto:yosserkhaldi2001@gmail.com" class="link"><i class="fal fa-envelope"></i> yosserkhaldi2001@gmail.com</a>
                            </div>
                        </div>
                   </div>
                   <div class="col-xl-8">
        ...
        <div class="col-xl-8">
            ...
            <form  method="POST" action='message.php'>
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            <textarea class="form-control" id="contact-message" rows="4" name="message" placeholder="Your Message (We would love to hear from you)" required></textarea>
                        </div>
                    </div>
                    <div class="col-12">
            ...
            <div id="message" class="alert-msg">
                ...
                if (isset($messageStatus)) {
                    if ($messageStatus === 'Message envoyé avec succès !') {
                        ...
                        echo "<p style='color: red;'>Échec de l'envoi du message. Veuillez réessayer ultérieurement.</p>";
                    }
                }
                ?>
            </div>
            ...
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3220.7498170047415!2d8.70357077534409!3d36.17264220282405!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x12fba452ae1d135f%3A0x1ae2217c9489ad95!2sAv.%20Mongi%20Slim%2C%20Le%20Kef!5e0!3m2!1sfr!2stn!4v1692018040721!5m2!1sfr!2stn" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
        </section>
        <!--=====================================-->
                        ...
                        <div class="col-xl-3 col-lg-6 col-sm-12 col-12">
                            <div class="footer-widget">
                                ...
                                <ul class="timing list-unstyled">
                                    <li>WEEK DAYS <span class="time">8 AM – 7 PM</span></li>
                                    <li>SATURDAY<span class="time">8 AM – 6 PM</span></li>
                                </ul>
                                <h6 class="title mt-4">ADDRESS</h6>
                                <a class="address" href="#"><i class="fal fa-map-marker-alt"></i> Le kef ,Tunisia</a>
                            </div>
                        </div>
