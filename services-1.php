...
<!-- Mirrored from techpedia.co.uk/template/stylen/services-1.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Aug 2023 13:24:11 GMT -->
<head>
    <!-- Meta Data -->
    <meta charset="UTF-8">
                        ...
                        <ul class="navbar-nav ms-auto me-auto mainmenu">
                            <li class="menu-item-has-children">
                                <a href="javascript:void(0);">Home</a>
                                    ...
                                    <li class="stylen-submenu"><a href="index-1.php">Home 1</a></li>
                            ...
                            <li class="menu-item-has-children">
                                ...
                                <ul class="stylen-submenu">
                                    <li><a href="services-1.php" class="active">Services 1</a></li>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="mynavbar-2">
                        <ul class="navbar-nav me-auto mainmenu">
                                    ...
                                    <li class="stylen-submenu"><a href="index-1.php">Home </a></li>
                                    ...
                                    <li class="stylen-submenu"><a href="services-1.php" class="active">Services </a></li>
            ...
            <div class="container">
                <div class="breadcrumb">
                    <ul>
                        ...
                        <li><a href="services-1.php" class="active">Services</a></li>
                    </ul>
                </div>
                <div class="heading">
                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-6 col-md-6">
                        <div class="service-box left-radius m-b-30">
                            ...
                            <div class="content">
                                ...
                                <p>We provides a variety of beauty services that will help you appear and feel your best.</p>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6">
                        <div class="service-box left-radius">
                            <div class="img-box">
                                <img src="assets/media/services/s-5.png" alt="">
                            </div>
                            <div class="content">
                                <h3>THERAPIES</h3>
                                <p>We provides a variety of beauty services that will help you appear and feel your best.</p>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6">
                        <div class="service-box left-radius">
                            <div class="img-box">
                                <img src="assets/media/services/s-6.png" alt="">
                            </div>
                            <div class="content">
                                <h3>WAXING</h3>
                                <p>We provides a variety of beauty services that will help you appear and feel your best.</p>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6">
                        <div class="service-box left-radius">
                            <div class="img-box">
                                <img src="assets/media/services/s-7.png" alt="">
                            </div>
                            <div class="content">
                                <h3>FACIALS</h3>
                                <p>We provides a variety of beauty services that will help you appear and feel your best.</p>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6">
                        <div class="service-box left-radius">
                            <div class="img-box">
                                <img src="assets/media/services/s-8.png" alt="">
                            </div>
                            <div class="content">
                                <h3>MASSAGE</h3>
                                <p>We provides a variety of beauty services that will help you appear and feel your best.</p>
