...
<head>
    ...
    <link href="fullcalendar-6.1.8/dist/fullcalendar.min.css" rel="stylesheet">
<script src="fullcalendar-6.1.8/dist/fullcalendar.min.js"></script>
    
    <!-- ... Autres éléments d'en-tête ... -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.29.1/moment.min.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/fullcalendar/5.9.0/fullcalendar.min.js"></script>
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/fullcalendar/5.9.0/fullcalendar.min.css">
    ...
    <div id="main-wrapper" class="main-wrapper">
        ...
        <section class="appointment background-1 sec-pad-80">
            <div class="container">
                ...
                <form method="post" action="page.php" id="form-wizard" class="submit-form">
                <input type="hidden" name="client_details" value="">
            ...
            $("#calendar").fullCalendar({
                ...
                select: function (start, end) {
                    ...
                    if (title) {
                        ...
                        $("#calendar").fullCalendar("renderEvent", eventData, true); // Ajoute l'événement au calendrier
                    }
                    $("#calendar").fullCalendar("unselect");
                },
                editable: true, // Permet de déplacer et de redimensionner les événements
                eventLimit: true, // Autorise "more" si trop d'événements
                events: [
                    // Ajoutez vos événements ici au format JSON
                    // Exemple :
                    // {
                    //     title: "My Event",
                    //     start: "2023-08-15",
